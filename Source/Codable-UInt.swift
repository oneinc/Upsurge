...
extension UInt {
    public typealias ValueArray = Upsurge.ValueArray<UInt>
    public typealias Matrix = Upsurge.Matrix<UInt>
    public typealias Array = Swift.Array<UInt>

    public struct BoxedValueArray: Codable, Equatable {
        
        public static func ==(
            lhs: UInt.BoxedValueArray,
            rhs: UInt.BoxedValueArray)
            -> Bool
        {
    ...
    public struct BoxedMatrix: Codable, Equatable {
        ...
        public static func ==(
            lhs: UInt.BoxedMatrix,
            rhs: UInt.BoxedMatrix)
            -> Bool
        {
