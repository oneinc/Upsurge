...
extension Int {
    public typealias ValueArray = Upsurge.ValueArray<Int>
    public typealias Matrix = Upsurge.Matrix<Int>
    public typealias Array = Swift.Array<Int>

    public struct BoxedValueArray: Codable, Equatable {
        
        public static func ==(
            lhs: Int.BoxedValueArray,
            rhs: Int.BoxedValueArray)
            -> Bool
        {
