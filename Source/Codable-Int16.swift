...
extension Int16 {
    public typealias ValueArray = Upsurge.ValueArray<Int16>
    public typealias Matrix = Upsurge.Matrix<Int16>
    public typealias Array = Swift.Array<Int16>

    public struct BoxedValueArray: Codable, Equatable {
        
        public static func ==(
            lhs: Int16.BoxedValueArray,
            rhs: Int16.BoxedValueArray)
            -> Bool
        {
    ...
    public struct BoxedMatrix: Codable, Equatable {
        ...
        public static func ==(
            lhs: Int16.BoxedMatrix,
            rhs: Int16.BoxedMatrix)
            -> Bool
        {
