...
extension UInt16 {
    public typealias ValueArray = Upsurge.ValueArray<UInt16>
    public typealias Matrix = Upsurge.Matrix<UInt16>
    public typealias Array = Swift.Array<UInt16>

    public struct BoxedValueArray: Codable, Equatable {
        
        public static func ==(
            lhs: UInt16.BoxedValueArray,
            rhs: UInt16.BoxedValueArray)
            -> Bool
        {
    ...
    public struct BoxedMatrix: Codable, Equatable {
        ...
        public static func ==(
            lhs: UInt16.BoxedMatrix,
            rhs: UInt16.BoxedMatrix)
            -> Bool
        {
